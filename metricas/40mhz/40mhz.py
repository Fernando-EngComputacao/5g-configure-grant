...
sym = np.loadtxt("delays_sym_ofdma_40MHz.txt")
rb = np.loadtxt("delays_rb_ofdma_40MHz.txt")
otdma = np.loadtxt("delays_5gl_tdma_40MHz.txt")
gl_ofdma = np.loadtxt("delays_5gl_ofdma_40MHz.txt")
...
plt.title("40 MHz") #Packet PDCP Delay
plt.grid(True)
plt.show()

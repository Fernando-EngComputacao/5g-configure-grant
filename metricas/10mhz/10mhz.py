...
sym = np.loadtxt("delays_sym_ofdma_10MHz.txt")
rb = np.loadtxt("delays_rb_ofdma_10MHz.txt")
otdma = np.loadtxt("delays_5gl_tdma_10MHz.txt")
gl_ofdma = np.loadtxt("delays_5gl_ofdma_10MHz.txt")
...
plt.title("10 MHz") #Packet PDCP Delay
plt.grid(True)
plt.show()
